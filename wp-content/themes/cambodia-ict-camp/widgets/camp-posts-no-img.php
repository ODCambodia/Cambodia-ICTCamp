        ...
        public function form( $instance )
        {
            ...
            <p>
                ...
                <input class="widefat" 
                    ...
                    name="<?php echo $this->get_field_name( 'unique_id' ); ?>" 
                    type="text" 
            ...
            <p>
                ...
                <input class="widefat" 
                    ...
                    name="<?php echo esc_attr( $this->get_field_name( 'post_number' ) ); ?>" 
                    type="number" 
            ...
            <p class="at-enable-prev-next">
                <input 
                    id="<?php echo esc_attr( $this->get_field_id( 'enable_prev_next' ) ); ?>" 
                    name="<?php echo esc_attr( $this->get_field_name( 'enable_prev_next' ) ); ?>" 
                    type="checkbox" 
            ...
            <p class="at-enable-prev-next">
                <input 
                    id="<?php echo esc_attr( $this->get_field_id( 'show_feature_image' ) ); ?>" 
                    name="<?php echo esc_attr( $this->get_field_name( 'show_feature_image' ) ); ?>" 
                    type="checkbox" 
                ...
                <section id="<?php echo esc_attr( $unique_id ); ?>" class="cict-widgets acme-col-posts <?php echo $bg_gray_class;?>">
                    <div class="container">
                        ...
                        <div id="<?php echo esc_attr( $unique_id );?>" <?php echo $div_attr;?>>
                            ...
                            while ( $event_star_featured_query->have_posts() ) {
                                $event_star_featured_query->the_post();
